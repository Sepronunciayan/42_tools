...
Allowed functions:
--------------------------------------------------------------------------------
Escribe una función que devuelva el número de elementos en la lista enlazada que se le pasa.
Debe declararse de la siguiente manera:

int ft_list_size(t_list *begin_list);

Debes usar la siguiente estructura, y entregarla como un archivo llamado ft_list.h:
